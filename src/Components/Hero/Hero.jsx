    ...
    <main className="h-[70vh] w-full flex">
      <div className="h-[70vh] w-1/2 flex flex-col gap-4 justify-center">
        ...
        <button className="h-14 w-36 mt-8 mx-40 rounded-full font-bold text-xl bg-blend-luminosity p-2 bg-white text-[#1d2e6d] animate-bounce shadow-lg shadow-blue-500 ">
          {" "}
          <a
            href="/src/Resume/Deepak Singh.pdf"
            download="Deepak Singh.pdf"
          >
            RESUME ↓
          </a>
        </button>
      ...
      <div className="h-full w-1/2 relative flex items-center justify-center">
        <div className="circle h-96 w-96 rounded-full blur-md bg-[#4c5ac3] flex items-center justify-center ">
          <div className="h-80 w-80 rounded-full blur-sm flex items-center justify-center bg-[#4c5ac3">
            <div className="h-72 w-72 rounded-full blur-sm bg-[#4c5ac3] "></div>
          </div>
        </div>
      </div>
